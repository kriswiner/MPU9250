...
// the faster the solution converges, usually at the expense of accuracy. In any
// case, this is the free parameter in the Madgwick filtering and fusion scheme.
float beta = sqrt(3.0f / 4.0f) * GyroMeasError;   // Compute beta
// Compute zeta, the other free parameter in the Madgwick scheme usually set to
// a small or zero value
...
// Forward declarations of below functions
